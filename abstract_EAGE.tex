...
Finally to verify it's performance in noisy areas was conducted an experiment with scaled models where were
tested three levels of white noise, the results are displayed in table \ref{t:scaled_models}
...
\bibliography{Ref_resistivimeter}
