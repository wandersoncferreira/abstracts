...
Figure \ref{f:Lock-in}, after the multiplication the product is goes
...
an output as a DC voltage signal described by equation \ref{e:v_out}.
...
With a narrow band filter it can filter almost all interferences
including these from electric power supplies, in our multifrequency
resistivimeter it can also be achieved samplig data in another
frequency.
